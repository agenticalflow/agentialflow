  ...
  const testimonials = [
    {
      ...
      author: "יובל",
      title: "בעל חנות מקוונת למוצרי חיות מחמד",
    },
    {
      text: "AgenticalFlow יצרו עבורנו מערכת שרודפת אחר לקוחות חייבים. הפסקנו להתעסק בגביה כמעט לחלוטין",
      author: "שחר",
      title: "בעל סטודיו לעיצוב בתל אביב",
    },
    {
      text: "AgenticalFlow בנו עבורנו בוט מבוסס מאניצ'ט שהגדיל את מספר הלקוחות החוזרים בכ-20%",
      author: "רוויטל",
      title: "בעלת אתר למכירת קוסמטיקה טבעית",
    },
    {
      text: "חסcono כ-15 שעות עבודה שבועיות הודות למערכת ניהול מלאי שמבצעת הזמנות אוטומטיות לפי הצורך",
      author: "רונית",
      title: "בעלת חנות אופנה בחדרה",
    },
  ]
